...
const Navbar = () => {
  ...
  return (
    <div className="text-white flex justify-between h-24 mx-auto px-4 max-h-[1240px] items-center">
      ...
      <li className="p-4 border-b border-b-lime-700"><Link to = '/resources' >Resources </Link></li>
        <li className="p-4 border-b border-b-lime-700"><Link to = '/company' >Company </Link></li>
        <li className="p-4 border-b border-b-lime-700"><Link to = '/' >Home </Link></li>
        <li className="p-4 border-b border-b-lime-700"><Link to = '/about' >About </Link></li>
        <li className="p-4 border-b border-b-lime-700"><Link to = '/contact' >Contact </Link></li>
      </ul>
